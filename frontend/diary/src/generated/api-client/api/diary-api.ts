...
export const DiaryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getDiaries: async (year?: number, month?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        getDiariesByUserId: async (userId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/diary/user/{userId}`
...
export const DiaryApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getDiaries(year?: number, month?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetDiariesResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getDiaries(year, month, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DiaryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getDiaries(year?: number, month?: number, options?: RawAxiosRequestConfig): AxiosPromise<GetDiariesResponse> {
            return localVarFp.getDiaries(year, month, options).then((request) => request(axios, basePath));
        },
        /**
         * UserID を指定して、日記を全件取得します。
         * @summary UserID を指定して、日記を全件取得します。
...
export class DiaryApi extends BaseAPI {
     ...
     * @memberof DiaryApi
     */
    public getDiaries(year?: number, month?: number, options?: RawAxiosRequestConfig) {
        return DiaryApiFp(this.configuration).getDiaries(year, month, options).then((request) => request(this.axios, this.basePath));
    }
